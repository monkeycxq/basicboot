...
public class CodeGenerator {
     ...
     * 数据库链接地址
     */
    private static final String URL = "jdbc:mysql://106.52.132.48:3306/basic_boot?useUnicode=true&useSSL=false&characterEncoding=utf8";
     ...
     * 密码
     */
    private static final String PASSWORD = "just4fun";

    /**
     * 作者
     */
    private static final String AUTHOR = "cxq";
